...
> [!NOTE]
> You need system administrator privileges to run the install script. If you encounter a problem, please [open an issue](https://github.com/wdmJieyao/beszel/issues/new).
...
```bash
curl -sL https://raw.githubusercontent.com/wdmJieyao/beszel/main/supplemental/scripts/install-hub.sh -o install-hub.sh && chmod +x install-hub.sh
```
...
```bash
curl -sL https://raw.githubusercontent.com/wdmJieyao/beszel/main/supplemental/scripts/install-agent.sh -o install-agent.sh && chmod +x install-agent.sh
```
